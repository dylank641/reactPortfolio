            ...
            <div className="portfolio-container">
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "An application that allows you to take notes instantly, save them, and also delete them when you please. This application was created using Express and UUID Moduels."
                ...
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "The Weather App gives you the current weather and a 5 day forecast of any city around the world. This was my first project using an API!"
                ...
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "This quiz will test you on you knowledge of javascript. It was made with basic HTML, CSS, and Javascript."
                ...
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "Password generator will ask you several questions about the length of your preferred password and the special characters you want included.It will then generate a random password, it was built using HTML, CSS, and JavaScript"
                ...
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "This was my first time building a real one page website. While it was quite simple to build, this project really opened my eyes to the infinite amount of possibilties you can pursue with code."
                ...
                <div className='project-container'>
                    <Project
                        ...
                        descrip = "This app was designed to keep the 9 to 5 worker on track throughout his day. This app was built with HTML, CSS, and Javascript"
